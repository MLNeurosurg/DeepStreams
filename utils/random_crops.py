...
parser.add_argument('-crops_per_image', type=int, help="Number of crops to generate per image")
...
if __name__ == '__main__':
    ...
    image_list = sorted([file for file in image_list if "png" in file or "tif" in file or "JPG" in file or "jpg" in file])
    mask_list = sorted([file for file in mask_list if "png" in file or "tif" in file or "JPG" in file or "jpg" in file])
    assert len(image_list) == len(mask_list)
